...
## 🎉 ¡Listo!
A partir de ese momento, cada persona que entre a tu CV en vivo ([https://rubenbarrios-bigdata.github.io/cv-html-ruben-barrios/](https://rubenbarrios-bigdata.github.io/cv-html-ruben-barrios/)) y haga clic en un KPI, descargue el PDF o use los filtros, enviará los eventos en tiempo real directo a tu panel de **Google Analytics 4** (`G-NQC5PHY67R`).
